...
public class TOPTWSolution {
    ...
    public String getInfoSolution() {
        ...
        for(int k = 0; k < this.getCreatedRoutes(); k++) { // rutas creadas
            ...
            pre = depot;
            int index = 0;
            strings[index++] = Integer.toString(pre);
            strings[index++] = Double.toString(this.getProblem().getX(pre));
            strings[index++] = Double.toString(this.getProblem().getY(pre));
            strings[index++] = Double.toString(this.getProblem().getReadyTime(pre));
            strings[index++] = Double.toString(this.getProblem().getDueTime(pre));
            strings[index++] = Integer.toString(0);
            strings[index++] = Integer.toString(0);
            strings[index++] = Double.toString(this.getProblem().getServiceTime(pre));
            text += ExpositoUtilities.getFormat(strings, width);
            text += "\n";
            do {                // recorremos la ruta
                ...
                textSolution += pre+" - ";
                strings[index++] = Integer.toString(suc);
                strings[index++] = Double.toString(this.getProblem().getX(suc));
                strings[index++] = Double.toString(this.getProblem().getY(suc));
                strings[index++] = Double.toString(this.getProblem().getReadyTime(suc));
                strings[index++] = Double.toString(this.getProblem().getDueTime(suc));
                ...
                if(costTimeRoute < (this.getProblem().getDueTime(suc))) {
                    ...
                    strings[index++] = Double.toString(costTimeRoute);
